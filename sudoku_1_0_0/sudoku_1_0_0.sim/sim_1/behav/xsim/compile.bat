...
REM
REM Generated by Vivado on Fri Dec 05 13:58:53 -0900 2025
...
echo "xvlog --incr --relax -L uvm -prj TestbenchSudokuEngine_vlog.prj"
call xvlog  --incr --relax -L uvm -prj TestbenchSudokuEngine_vlog.prj -log xvlog.log
