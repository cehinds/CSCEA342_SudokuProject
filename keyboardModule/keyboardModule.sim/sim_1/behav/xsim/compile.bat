...
REM
REM Generated by Vivado on Sat Nov 29 19:49:07 -0900 2025
...
echo "xvlog --incr --relax -L uvm -prj sudoku_top_vlog.prj"
call xvlog  --incr --relax -L uvm -prj sudoku_top_vlog.prj -log xvlog.log
