...
REM
REM Generated by Vivado on Sat Nov 29 21:44:36 -0900 2025
...
echo "xvlog --incr --relax -L uvm -prj tb_keyboard_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_keyboard_vlog.prj -log xvlog.log
