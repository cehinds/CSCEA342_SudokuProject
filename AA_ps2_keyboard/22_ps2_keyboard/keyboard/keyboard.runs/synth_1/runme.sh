...
HD_PWD='C:/Users/sjneumayer/Desktop/AA_ps2_keyboard/22_ps2_keyboard/keyboard/keyboard.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log KeyboardToSevenSegment.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source KeyboardToSevenSegment.tcl
