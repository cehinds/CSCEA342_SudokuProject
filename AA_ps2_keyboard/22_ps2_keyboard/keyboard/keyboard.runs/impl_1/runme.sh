...
HD_PWD='C:/Users/sjneumayer/Desktop/AA_ps2_keyboard/22_ps2_keyboard/keyboard/keyboard.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log KeyboardToSevenSegment.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source KeyboardToSevenSegment.tcl -notrace
